...
const api = {
  ...
  findSearchAppChannel(params) {
    return fetch({
      url: '/search/findSearchAppChannel',
      method: 'GET',
      params: params
    });
  },
  ...
  findAppChannelRanks(params) {
    return fetch({
      url: '/behavior/findChannelAppTrendRanks',
      method: 'GET',
      params: params
    });
  },
  ...
  findChannelAppTrends(params) {
    return fetch({
      url: '/behavior/findChannelAppTrends',
      method: 'GET',
      params: params
    });
  },
  ...
  findAppChannelTrends(params) {
    return fetch({
      url: '/behavior/findAppChannelTrends',
      method: 'GET',
      params: params
    });
  },
